...
namespace UnitKing.Store
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void currentInput_TextChanged(object sender, TextChangedEventArgs e)
        {
            int num = 0;
        ...
        private void carbohydrateInput_TextChanged(object sender, TextChangedEventArgs e)
        {
            int num = 0;
            if (int.TryParse(((TextBox)sender).Text, out num))
            {
